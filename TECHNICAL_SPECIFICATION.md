...
- `Name` (string) - ФИО заказчика
- `Phone_number` (int) - номер телефона заказчика
- `Order` (string) - состав заказа
...
- `Id`(int,PK) - уникальный идентификатор
- `Date` (date)- дата оплаты подписки
- `DateFinal` (date) - дата окончания подписки
- `CVV` (int) - код безопасности с карты оплаты
- `Tariff` (int) - тариф в днях 
